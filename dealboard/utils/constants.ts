...
export const JWT_EXPIRATION_TIME = "2000s"; // 20 seconds
...
export const BASE_SPRING_URL = process.env.EXPO_PUBLIC_SPRING_BASE_URL;
export const SPRING_TUNNEL = process.env.EXPO_PUBLIC_ANDROID_TUNNEL;
